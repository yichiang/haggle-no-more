...
folium.Marker(
      ...
      popup="Bangkok Bank and Foreign Exchanging Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)

folium.Marker(
      location=[13.752434, 100.494971],
...
folium.Marker(
      location=[13.808686, 100.57555],
      popup="Bangkok Bank and Foreign Exchange Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)

folium.Marker(
      location=[13.667771, 100.636604],
      popup="Bangkok Bank and Foreign Exchange Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)

folium.Marker(
      location=[13.726532, 100.5304],
      popup="Bangkok Bank and Foreign Exchange Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)
...
folium.Marker(
      location=[13.689795, 100.550095],
      popup="Bangkok Bank and Foreign Exchange Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)

folium.Marker(
      location=[13.7553835, 100.52458],
      popup="Bangkok Bank and Foreign Exchange Center",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)

folium.Marker(
      location=[13.860506, 100.66813],
      popup="CAJA MURCIA",
      icon=folium.Icon(color='green', icon='credit-card'),
    ).add_to(marker_cluster)
